                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink
                            ...
                            :active="route().current().startsWith('course')"
                        >
                            Course
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            :href="route('assignment.index')"
                            :active="route().current().startsWith('assignment')"
                        >
                            Assignment
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            :href="route('quiz.index')"
                            :active="route().current().startsWith('quiz')"
                        >
                            Quiz
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            href="#"
                            :active="route().current().startsWith('post')"
                        >
                            Forum
                        </ResponsiveNavLink>
                    </div>
